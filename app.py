...
# Set a professional, simple background color with CSS
st.markdown(
    """
    <style>
    body {
    ...
    .main {
        ...
        padding: 20px;
        border-radius: 10px;
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Subtle shadow for card-like effect */
    }
...
# Load your data
df = pd.read_csv('/content/3Signet_David_cleaned_data_1 (1).csv')
...
# Predict using the same features (for demonstration; typically you'd use a separate test set)
